...
//
let a = {//Обявляем исхожный обект который будет this в формуле foo
name: 'static',
count: 0
}
function foo(key, repet){//принимает 2 хначения key принимает значение необходимого ключя че значение необходимо изменять
